 ...
 * @author syah
 */
@WebServlet(name = "tambahkanGuru", urlPatterns = {"/tambahkanGuru"})
public class tambahkanGuru extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String sql = "INSERT INTO guru(id_guru,nama_depan,nama_tengah,nama_belakang,gender,alamat_guru,detail_guru,email,no_hp,pswd) VALUES(nextval('seq_guru'),'"+namadepan+"','"+namatengah+"','"+namabelakang+"','"+jeniskelamin+"','"+alamat+"','"+detail+"','"+email+"','"+nohp+"','"+pswd+"')";
            Statement st = konek.createStatement();           
            int status = st.executeUpdate(sql);           
            response.sendRedirect("admin/semua-guru.jsp");
            }catch(Exception e){
