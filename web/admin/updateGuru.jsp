<%-- 
    Document   : updateGuru
    Created on : Dec 30, 2017, 11:08:58 AM
    Author     : syah
--%>
...
<%        
        try{
            ...
            <%                                    
            String sql = "UPDATE guru SET gender='"+jeniskelamin+"',nama_depan='"+namadepan+"',nama_tengah='"+namatengah+"',nama_belakang='"+namabelakang+"',detail_guru='"+detail+"',no_hp='"+nohp+"',email='"+email+"',alamat_guru='"+alamat+"' WHERE id_guru="+nis+"";
            Statement st = konek.createStatement();           
            int status = st.executeUpdate(sql);           
            response.sendRedirect("semua-guru.jsp");
