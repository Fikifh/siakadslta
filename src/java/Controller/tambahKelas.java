...
public class tambahKelas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String kdkls = request.getParameter("kdkls");           
            String nmkls = request.getParameter("nmkls");           
            try{
               String sql = "INSERT INTO kelas VALUES(nextval('seq_kelas'),'"+kdkls+"','"+nmkls+"')";
               TheConnection konek = new TheConnection();
               konek.execute(sql);                              
               out.println("<body onload="+"'alert('berhasil!')'"+"></body>");
               response.sendRedirect("/Siakadslta/admin/tambah-kelas.jsp");
           }catch(Exception e){
